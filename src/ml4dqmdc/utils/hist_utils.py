...
def normalizehists(hists, norm: Optional[str] = None):
    ### perform normalization on a set of histograms
    # input arguments:
    # - hists: a numpy array of shape (nhistograms,nbins) for 1D or (nhistograms,nybins,nxbins) for 2D
    # - norm (optional): Normalization strategy.
...
def running_average_hists(hists, window=None, weights=None):
    ...
    #   note: the defau51lt behaviour is a uniform array with values 1./(window+1) (or 1./(nprevious+1+nnext))
    # returns:
